...
| `docs/` | all | Active task briefs, the roadmap, the decision records, and `counterparty-matching.md` — how the hard column works, and what was measured and rejected getting there |
